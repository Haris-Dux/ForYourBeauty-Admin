...
//API URL
const getSalesStatisticsUrl = `http://localhost:8080/api/dashboard/getSalesStatistics`;
const getmonthlyOrdersUrl = `http://localhost:8080/api/dashboard/getMonthlyOrdersDifference`;
const getPercentageOfOrderProgressUrl = `http://localhost:8080/api/dashboard/getPercentageOfOrderProgress`;
const getOrderCountsByMonthsUrl = `http://localhost:8080/api/dashboard/getOrderCountsByMonth`;
